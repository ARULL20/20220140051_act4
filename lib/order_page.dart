        ...
        child: Column(
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Food Quantity Order'),
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please enter the quantity of food order';
                }
                return null;
              },
            ),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Drink Quantity Order'),
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please enter the quantity of drink order';
                }
                return null;
              },
            ),
